...
import { IoCloseSharp, IoFastFoodOutline, IoHomeOutline } from "react-icons/io5";
  ...
  return (
	...
	<div className="divide-y dark:divide-gray-300">
        ...
        <ul className="pt-2 pb-4 space-y-1 text-sm">
			...
			<li>
				<Link to='/dashboard/manageUsers'  className="flex items-center p-2 space-x-3 rounded-md">
			...
			<li>
				<Link to='/dashboard/addMeal'  className="flex items-center p-2 space-x-3 rounded-md">
			...
			<li>
				<Link to='/dashboard/allMeals'  className="flex items-center p-2 space-x-3 rounded-md">
                    <BiFoodMenu className="w-5 h-5 fill-current dark:text-gray-600" />
					<span>All Meals</span>
				</Link>
			</li>
			<li>
				<Link to='/dashboard/allReviews'  className="flex items-center p-2 space-x-3 rounded-md">
                    <MdOutlineReviews className="w-5 h-5 fill-current dark:text-gray-600" />
					<span>All Reviews</span>
				</Link>
			</li>
            <li>
				<Link to='/dashboard/serveMeals'  className="flex items-center p-2 space-x-3 rounded-md">
                    <LuAlignVerticalDistributeEnd className="w-5 h-5 fill-current dark:text-gray-600"  />
					<span>Serve Meals</span>
				</Link>
			</li>
            <li>
				<Link to='/dashboard/upcomingMeals'  className="flex items-center p-2 space-x-3 rounded-md">
