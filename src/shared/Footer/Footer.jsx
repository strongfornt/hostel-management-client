          ...
          <div
            ...
            >
              ...
              <span
                ...
                data-aos-delay="500 "
                data-aos-duration="1000"
                className="font-extrabold  text-2xl text-[#3F72AF]  "
              >
                <span className="text-3xl font-bold">Dine</span>
                <span className="  font-bold text-base-100 dark:text-white  ">Ease</span>
              </span>
            </div>
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-1">
               ...
               <li
                  ...
                  data-aos-delay="1200 "
                  data-aos-duration="1200"
                  className="hover:text-[#3F72AF] duration-300"
            ...
            <div className="space-y-3 ">
              ...
              <ul className="space-y-1">
               ...
               <li
                ...
                >
                     <FaLocationDot className="text-[#3F72AF]" />
                ...
                <li
                  ...
                  className="flex items-center"
                >
                    <FaPhoneAlt className="text-[#3F72AF]" />
                  <a rel="noopener noreferrer" className="ml-2" href="#">
                    13-543-135
                  </a>
                </li>
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-start space-x-3">
               ...
               <a
                  ...
                  href="#"
                  title="Facebook"
                  className="flex items-center p-1 hover:text-[#3F72AF] duration-300"
                >
                  <svg
