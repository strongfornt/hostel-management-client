  ...
  return (
	...
	<div className="container mx-auto p-4 mb-8">
		<div className="mb-8 space-y-4 text-center">
            ...
            <h1 className={` text-2xl md:text-3xl font-semibold leading-tight ${theme === "light" && 'text-[#4b5664]'}`}>Choose Your  <span className="text-[#3F72AF]" >Membership</span></h1>
        <p
          className={`text-sm text-center mb-8 max-w-screen-sm mx-auto ${
            theme === "light" ? "text-[#4b5664]" : "text-white"
          }`}
        >
            Upgrade to Silver, Gold, or Platinum and enjoy exclusive benefits. Click on your chosen package to checkout.
